...
namespace TestReg
{
    class Program
    {
        ...
        {
            string[] myargs = new string[] { "t.rcode", "-trace", "-dis", "-dump" };
            Execute(myargs);

            myargs = new string[] { "t2.rcode", "-trace", "-dis", "-dump" };
            Execute(myargs);

            myargs = new string[] { "t3.rcode", "-trace", "-dis", "-dump" };
            Execute(myargs); 
            
            myargs = new string[] { "t4.rcode", "-trace", "-dis", "-dump" };
            Execute(myargs); 
            
            myargs = new string[] { "struct.rcode", "-trace", "-dis", "-dump" };
            Execute(myargs);
        ...
        public static void Execute(string[] args)
        {
            ...
            interpreter.Load(interpreter, input);
